...
class Main(QtGui.QMainWindow):
    ...
    def controllerUpdate(self):
        ...
        publisherText = ps3_data_publisher.ps3_publisher(self.ps3.horizontal_front_speed, self.ps3.horizontal_side_speed, self.ps3.z_speed, self.ps3.pitch_speed, self.ps3.yaw_speed, 0, 'turtle1/cmd_vel')
