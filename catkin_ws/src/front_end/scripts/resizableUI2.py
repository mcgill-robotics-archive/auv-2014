...
class Ui_RoboticsMain(object):
    def setupUi(self, RoboticsMain):
        ...
        self.horizontalLayout.addWidget(self.logObject)
        ...
        self.horizontalLayout_2.addLayout(self.vidArray)
    ...
    def retranslateUi(self, RoboticsMain):
        ...
        self.label.setText(QtGui.QApplication.translate("RoboticsMain", "Graphics", None, QtGui.QApplication.UnicodeUTF8))
