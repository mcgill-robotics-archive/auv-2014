...
#
# Created: Fri Apr 25 07:53:14 2014
...
class Ui_RoboticsMain(object):
    def setupUi(self, RoboticsMain):
        ...
        self.bat_lcd2 = QtGui.QLCDNumber(self.tab)
        ...
        self.pressure_lcd = QtGui.QLCDNumber(self.tab)
        self.pressure_lcd.setObjectName(_fromUtf8("pressure_lcd"))
        self.gridLayout_6.addWidget(self.pressure_lcd, 1, 0, 1, 1)
        self.gridLayout_6.setColumnMinimumWidth(0, 100)
        self.gridLayout_6.setColumnMinimumWidth(1, 100)
        self.gridLayout_6.setColumnMinimumWidth(2, 100)
        self.gridLayout_6.setColumnMinimumWidth(3, 100)
        ...
        self.verticalLayout_8.addWidget(self.thruster_stop)
        ...
        self.verticalLayout_8.addWidget(self.ps3_present)
    ...
    def retranslateUi(self, RoboticsMain):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtGui.QApplication.translate("RoboticsMain", "Basic Information", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtGui.QApplication.translate("RoboticsMain", "Additionnal Options", None, QtGui.QApplication.UnicodeUTF8))
